...
docker run --rm -v $(pwd):/docs squidfunk/mkdocs-material:6.0.2 deploy $MIKE_VERSION $MIKE_ALIAS --update-aliases
docker run --rm -v $(pwd):/docs squidfunk/mkdocs-material:6.0.2 set-default $MIKE_VERSION
